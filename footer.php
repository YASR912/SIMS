<footer class="footer">
    <div class="d-sm-flex justify-content-center font-weight-bold">
        <div class="animation-section">
            <span class="static-txt"></icon> Developed by </span>
            <span class="dynamic-txt"></span>
        </div>
    </div>
    <p class="mb-0 small text-center mt-2">&copy; 2026 Smart Inventory Group. All Rights Reserved.</p>
</footer>
...
const names = ["Yasir Osman", "Izzaldin Badawi"];
let currentIndex = 0;
let charIndex = 0;
const speed = 150;
